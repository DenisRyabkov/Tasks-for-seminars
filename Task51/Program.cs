...
// Найдите сумму элементов, находящихся на главной диагонали с индексами [0,0]; [1,1] и тд
// Пример: задан массив 
//
// 1 4 7 2 
// 5 9 2 3 
...
int[,] array2d = CreateMatrixRndInt(7, 3, 0, 10);
PrintMatrix(array2d);

int summa = SumElementDiagonal(array2d);
